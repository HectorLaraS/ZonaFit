...
class ClientView:
    ...
    def client_view(self):
        ...
        btn_agregar.grid(row=0, column=0, sticky="ew", padx=8, pady=8)
        btn_editar.grid(row=0, column=1, sticky="ew", padx=8, pady=8)
        btn_eliminar.grid(row=0, column=2, sticky="ew", padx=8, pady=8)
        btn_guardar.grid(row=0, column=3, sticky="ew", padx=8, pady=8)
